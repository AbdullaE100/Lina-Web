        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12 mb-12 sm:mb-16">
          ...
          <div className="sm:col-span-2 lg:col-span-5">
            ...
            <div className="flex items-center gap-2 text-[#C0A875] mb-5 sm:mb-6">
              ...
              <span className="text-[10px] xs:text-xs tracking-wider">
            ...
            <div className="flex flex-col space-y-4">
              <a
                ...
                className="flex items-center space-x-3 xs:space-x-4 group"
              >
                ...
                <span className="text-gray-300 text-sm xs:text-base group-hover:text-white transition-colors duration-300">
                  lina.nizar@xrealty.ae
                </span>
              </a>
          ...
          <div className="sm:col-span-1 lg:col-span-4 mt-2 sm:mt-0">
            ...
            <p className="text-gray-300 text-sm xs:text-base mb-5 xs:mb-6 leading-relaxed">
              Subscribe for exclusive market insights and investment
              opportunities.
            </p>
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8 mt-10 sm:mt-12">
          <div className="flex flex-col sm:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 sm:space-x-6 mt-4 sm:mt-0">
              <a
                href="#"
                className="text-xs sm:text-sm text-gray-500 hover:text-gray-400 transition-colors tap-highlight-transparent"
              >
                Privacy Policy
              </a>
              <a

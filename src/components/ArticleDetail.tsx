    ...
    <div className="fixed inset-0 bg-black/90 backdrop-blur-md z-50 overflow-y-auto">
      <div className="container mx-auto px-6 py-12">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg">
          ...
          <div className="mb-8">
            <div className="text-[#C0A875] font-semibold mb-3 font-ui">
              {category}
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl mb-4 text-primary leading-tight">
              {title}
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-6 font-serif">
              {excerpt}
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
            {stats.map((stat, idx) => (
              <div key={idx} className="bg-[#F8F7F5] p-4 rounded-lg">
                <div className="text-sm text-muted-foreground font-ui mb-1">
                  {stat.label}
                </div>
          ...
          <div className="mt-12 pt-8 border-t border-border">
            ...
            <p className="text-muted-foreground mb-6 font-serif">
              Schedule a personalized consultation to discuss your investment
              goals and discover exceptional opportunities in Dubai.
            </p>
            <Button

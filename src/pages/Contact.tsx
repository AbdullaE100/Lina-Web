...
const Contact = () => {
  ...
  const contactInfo = [
    {
      title: "Email",
      value: "lina.nizar@xrealty.ae",
      icon: <Mail className="w-5 h-5" />,
      link: "mailto:lina.nizar@xrealty.ae",
    },
    {
      title: "Phone",
      value: "+971583083124",
      icon: <Phone className="w-5 h-5" />,
      link: "tel:+971583083124",
    },
    {
      title: "Instagram",
    ...
    if (formSubmitted) {
      return (
        ...
        >
          ...
          <h3 className="text-2xl font-luxury text-primary mb-3">
            Message Sent!
          </h3>
          <p className="text-muted-foreground max-w-md">
            Thank you for reaching out. I'll personally respond to your inquiry
            within 24 hours.
          </p>
        </motion.div>
      );
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <Label
              htmlFor="name"
              className="text-primary font-medium block font-ui text-sm"
            >
              Full Name
            </Label>
            <Input
        ...
        <div className="max-w-7xl mx-auto px-4 xs:px-5 sm:px-6 relative">
          <div className="max-w-3xl">
            ...
            <p className="text-lg xs:text-xl text-[#666666] max-w-xl mb-0 font-serif">
              Whether you're looking to invest in luxury real estate or need
              expert market insights, I'm here to assist you.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
            ...
            <div className="lg:col-span-7 xl:col-span-8">
              <div className="bg-white border border-gray-100 shadow-sm p-6 xs:p-8 sm:p-10">
                <h2 className="text-2xl xs:text-3xl font-luxury text-[#1A1A1A] mb-6">
                  Send a Message
                </h2>
            ...
            <div className="lg:col-span-5 xl:col-span-4">
              <div className="bg-[#F8F7F4] p-6 xs:p-8 sm:p-10 h-full">
                ...
                <div className="space-y-8">
                  {contactInfo.map((item, index) => (
                    ...
                    >
                      ...
                      <div className="ml-4">
                        <h3 className="font-ui uppercase text-xs tracking-wider text-[#666666] mb-1">
                          {item.title}
                        </h3>
                        <a
                          href={item.link}
                ...
                <div className="mt-10 pt-8 border-t border-gray-200">
                  <h3 className="text-xl font-luxury text-[#1A1A1A] mb-3">
                    Prefer a Meeting?
                  </h3>
                  <p className="text-[#666666] mb-6 text-sm">
                    Schedule a personal consultation at a time that's convenient
                    for you.
                  </p>
                  <TouchButton
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  >
                    <div className="flex items-center mb-3">
                      ...
                      <h3 className="text-lg font-luxury text-primary">
                        Colombo
                      </h3>
                    </div>
                  ...
                  >
                    ...
                    <address className="text-muted-foreground not-italic text-sm font-serif leading-relaxed">
                      ...
                      <br />
                      Office 301 & 302 Park Heights Square Building 1,
                      <br />
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-serif">
              Common questions about working with Lina and real estate
              investments
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                answer:
                  "Investment thresholds vary by market and project type. We work with clients across all investment levels, from first-time buyers to institutional investors.",
              },
              {
                question: "Do you charge consultation fees?",
                answer:
                  "Initial strategy sessions are complimentary. Ongoing advisory services are structured based on the scope and complexity of your investment needs.",
              },
              {
              ...
              },
              {
                ...
                answer:
                  "Timeline varies by project type. Pre-launch opportunities can close quickly, while traditional purchases typically take 4-8 weeks from offer to completion.",
              },
              {
                question: "Can you help with property management?",
                answer:
                  "Yes, I offer comprehensive property management solutions for international investors, ensuring hassle-free ownership and maximized returns.",
              },
              {
                question: "What makes your service different?",
                answer:
                  "My dual-market expertise, exclusive access to pre-launch opportunities, and personalized investment strategies tailored to individual client goals set my services apart.",
              },
            ].map((faq, index) => (
              <motion.div
                key={index}

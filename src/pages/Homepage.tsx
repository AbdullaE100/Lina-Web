  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <VideoBackground
          src={
            "https://res.cloudinary.com/dkhns25jh/video/upload/v1756215772/j9hkuyxz39aygr1cuu4x.mp4"
          }
        ...
        <div className="container px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            >
              Guiding discerning investors through exceptional real estate
              opportunities with strategic market intelligence and cultural
              expertise.
            </motion.p>
      ...
      <section className="py-16 xs:py-20 sm:py-24 bg-white relative overflow-hidden">
        <div
          ...
          style={{ backgroundImage: 'url("/patterns/subtle-dots.svg")' }}
        ></div>
        ...
        <div className="max-w-7xl mx-auto px-4 xs:px-5 sm:px-6 relative z-10">
          ...
          >
            ...
            <p className="text-[#666666] max-w-2xl mx-auto text-responsive-base px-4 xs:px-6 sm:px-0">
              Premium real estate opportunities in the most sought-after
                ...
                {[
                  {
                    ...
                    description:
                      "Luxury waterfront residences with panoramic ocean views and world-class amenities",
                  ...
                  },
                  {
                    ...
                    location: "Dubai, UAE",
                    description:
                      "A visionary 15-minute city evolving from Expo 2020's legacy with premium residential spaces",
                  ...
                  },
                  {
                    ...
                    location: "Colombo, Sri Lanka",
                    description:
                      "Iconic twin-tower development with innovative design and unparalleled city views",
                    image: altairProject,
                  },
                ].map((property, index) => (
                  <CarouselItem
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                        <div className="text-[#C0A875] font-semibold text-xs mb-1">
                          {property.location}
                        </div>
                        <h3 className="font-luxury text-2xl mb-2">
                          {property.title}
                        </h3>
                        <p className="text-white/90 text-sm mb-4 line-clamp-2 font-serif">
                          {property.description}
                        </p>
                        <Link
                          to="/portfolio"
                          className="inline-flex items-center gap-2 text-white text-xs font-medium border-b border-[#D4BC8A] pb-1 hover:border-white"
                        >
              ...
              {[
                ...
                >
                  ...
                  <div className="p-5 xs:p-6">
                    <p className="text-[#C0A875] font-semibold text-xs sm:text-sm mb-1 uppercase tracking-wider">
                      {property.location}
                    </p>
                    <h3 className="font-luxury text-xl sm:text-2xl text-[#1A1A1A] mb-2">
                      {property.title}
                    </h3>
                    <p className="text-[#666666] text-sm sm:text-base mb-4 font-serif line-clamp-2">
                      {property.description}
                    </p>
                    <Link
                      to="/portfolio"
                      className="inline-flex items-center gap-2 text-[#C0A875] text-sm font-medium border-b border-transparent hover:border-[#C0A875] transition-all"
                    >
                      <span>View Details</span>
                      <ArrowRight className="w-4 h-4" />
                    </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-[#666666] max-w-2xl mx-auto text-responsive-base">
              Leveraging deep market knowledge and a vast network to deliver
                ...
                {[
                  {
                    ...
                    description:
                      "Decades of experience in luxury markets of Dubai and Sri Lanka.",
                  },
                  {
                    icon: Globe,
                    title: "Global Network",
                    description:
                      "Access to exclusive off-market properties and international investors.",
                  },
                  {
                    icon: Users,
                    title: "Client-Centric Approach",
                    description:
                      "Bespoke services tailored to your unique investment goals.",
                  },
                  {
                    icon: Shield,
                    title: "Utmost Discretion",
                    description:
                      "Your privacy is paramount in all our transactions.",
                  },
                  {
                    icon: BarChart3,
                  ...
                  },
                  {
                    ...
                    description:
                      "Creative strategies for complex real estate challenges.",
                  },
                ].map((feature, index) => (
                  <CarouselItem key={index} className="basis-full">
                    ...
                    >
                      ...
                      <h3 className="font-luxury text-xl text-[#1A1A1A] mb-2">
                        {feature.title}
                      </h3>
      ...
      <section className="py-16 sm:py-24 bg-[#F8F6F1] relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            />
            <p className="text-[#666666] max-w-2xl mx-auto text-responsive-base">
              Discover why discerning investors trust our expertise and
              guidance.
            </p>
          </motion.div>
              ...
              {[
                {
                  ...
                  location: "Dubai, UAE",
                  quote:
                    "Lina’s insights into the Dubai market are unparalleled. Her team guided us to a lucrative off-market opportunity we would have otherwise missed. A truly bespoke and professional service.",
                ...
                },
                {
                  ...
                  location: "Colombo, Sri Lanka",
                  quote:
                    "As a first-time investor in Sri Lanka, I was nervous. Lina’s expertise and patient guidance made the entire process seamless and successful. Her cultural understanding is a huge asset.",
                ...
                },
                {
                  ...
                  location: "Singapore",
                  quote:
                    "The level of due diligence and market analysis provided is exceptional. We felt confident in every decision, knowing it was backed by solid data and years of experience. Highly recommended.",
                ...
                <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                  <div className="p-1 h-full">
                    ...
                    >
                      ...
                      <p className="text-[#666666] italic font-serif flex-grow">
                        "{testimonial.quote}"
                      </p>
                    </motion.div>
                  </div>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            />
            <p className="text-[#666666] max-w-2xl mx-auto text-responsive-base">
              Explore our latest articles and analyses on the evolving real
              estate landscape.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "A framework for identifying and capitalizing on pre-launch and off-market properties.",
                image: insightPreLaunch,
                link: "/insights/pre-launch-advantage",
              },
              {
                title: "Diaspora Investment Guide",
                description:
                  "Navigating the opportunities and challenges of investing in Sri Lanka from abroad.",
                image: insightDiaspora,
                link: "/insights/diaspora-investment-guide",
              },
              {
                title: "Currency Risk in Real Estate",
                description:
                  "Strategies to mitigate the impact of currency fluctuations on your property investments.",
                image: insightCurrencyRisk,
                link: "/insights/currency-risk-strategies",
              },
            ].map((article, index) => (
              <motion.div
                key={index}
              ...
              >
                <Link to={article.link} className="block">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-[#666666] font-serif mb-4">
                      {article.description}
                    </p>

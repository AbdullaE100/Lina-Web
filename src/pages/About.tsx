  ...
  const experience = [
    {
      ...
      description:
        "Founded and led a leading real estate firm specializing in luxury condominiums, diaspora investment, and global property sales. Led over LKR 1 billion in revenue through data-driven campaigns, off-plan sales, and bespoke client advisory.",
    },
    {
      year: "2023 - Present",
      ...
      description:
        "Led strategic real estate investment initiatives focused on market development and international partnerships. Spearheaded partnerships with international real estate companies.",
    },
    {
      year: "2023 - Present",
      ...
      role: "Member",
      description:
        "Active member of the global EO network, with a focus on leadership development, strategic investment, and entrepreneurial growth.",
    },
  ];
  ...
  return (
    <div ref={scrollRef} className="bg-white text-gray-800">
      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl text-white">
            ...
            >
              With over two decades of trailblazing leadership in real estate, I
              specialize in transforming high-potential markets into thriving
              investment landscapes. My expertise lies in architecting success
              for iconic luxury developments and empowering investors with
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="font-luxury text-3xl md:text-4xl text-[#1A1A1A] mb-4">
                My Philosophy
              </h2>
              ...
              <p className="text-lg md:text-xl text-[#666666] font-serif leading-relaxed italic">
                "I believe luxury real estate is more than transactions—it's
                about forging lasting value through strategic vision,
                data-driven intelligence, and an unwavering commitment to
                excellence. My approach combines deep market knowledge with
                personalized client relationships to turn ambitious goals into
                tangible assets."
              </p>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-12 md:mb-16">
            ...
            <p className="text-lg text-[#666666]">
              A career dedicated to excellence in real estate and
              entrepreneurship.
            </p>
          </div>
                ...
                <div className="flex items-center">
                  <div
                    className={`w-1/2 ${
                      index % 2 === 0
                        ? "pr-8 text-right"
                        : "pl-8 text-left order-2"
                    }`}
                  >
                    <p className="text-sm font-semibold text-[#C0A875]">
                      {item.year}
                    </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-12 md:mb-16">
            ...
            <p className="text-lg text-[#666666]">
              A proven track record of delivering exceptional results.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-[#1A1A1A] text-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-12 md:mb-16">
            <h2 className="font-luxury text-3xl md:text-4xl mb-4">
              Core Competencies
            </h2>
            <p className="text-lg text-white/80">
              The strategic pillars that underpin my success.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Mastery of high-value property transactions, from sourcing to closing.",
              },
              {
                title: "Investment Strategy",
                description:
                  "Crafting data-driven strategies for optimal portfolio growth and risk management.",
              },
              {
                title: "Property Development",
                description:
                  "End-to-end management of luxury projects, ensuring quality and profitability.",
              },
              {
                title: "Diaspora Investment",
                description:
                  "Specialized expertise in facilitating seamless cross-border investments for the diaspora.",
              },
            ].map((skill, index) => (
              <motion.div
                key={index}
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }}
              >
                <h3 className="text-lg font-semibold text-[#D4BC8A] mb-2">
                  {skill.title}
                </h3>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-xl mx-auto mb-8">
              Whether you're seeking to expand your portfolio or embark on a new
              development project, my expertise is at your service. Let's
              connect to explore the possibilities.
            </p>
            <Button
              asChild
              className="bg-[#C0A875] text-black font-semibold tracking-wider rounded-none px-10 py-7 text-sm hover:bg-[#D4BC8A] transition-colors duration-300"
            >
